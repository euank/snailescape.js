...
;(function() {
  ...
  function Parser(opts) {
    ...
    this.doubleQuoteEscapes = opts.quoteCharacters || ['"'];
    this.singleQuoteEscapes = opts.rawQuoteCharacters || ["'"];
    this.spaceChars = opts.spaceChars || [" ", "\t"];
  }
  ...
  Parser.prototype.parse = function(str) {
    ...
    for(i = 0; i < str.length; i++) {
      ...
      if(inDoubleQuotes !== false) {
        ...
        var doubleQuoteChar = findElement(self.doubleQuoteEscapes, str[i]);
        if(doubleQuoteChar !== false) {
            inDoubleQuotes = doubleQuoteChar;
            continue;
        }

        var singleQuoteChar = findElement(self.singleQuoteEscapes, str[i]);
        ...
        var spaceChar = findElement(self.spaceChars, str[i]);
        if(spaceChar !== false) {
          if(currentPart !== "") {
            parts.push(currentPart);
            currentPart = "";
